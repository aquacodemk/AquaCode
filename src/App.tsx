  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 pb-20 flex flex-col">
      ...
      <main className="mt-6 flex-grow">
        ...
        {activeTab === 'tactics' && (
          <TacticsBoard onSaveToGallery={addGalleryImage} />
        )}
                         ...
                         <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:shadow-md transition-shadow">
                            ...
                            <div>
                               ...
                               <div className="flex gap-3 mt-3">
                                  ...
                                  <a href="https://www.youtube.com/@vaseto_ime" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center hover:bg-red-700 transition">
                                     <Youtube size={16} />
                                  </a>
                               </div>
                            </div>
