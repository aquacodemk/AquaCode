...
const App: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // HARDCODED PASSWORD HERE - Change 'aqua123' to whatever you want
                         ...
                         <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:shadow-md transition-shadow">
                            ...
                            <div>
                               ...
                               <div className="flex gap-3 mt-3">
                                  <a href="https://www.facebook.com/VASETO_IME" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center hover:bg-blue-700 transition">
                                     <Facebook size={16} />
                                  </a>
                                  <a href="https://www.instagram.com/aquacode1" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-pink-600 text-white rounded-full flex items-center justify-center hover:bg-pink-700 transition">
                                     <Instagram size={16} />
                                  </a>
                                  <a href="https://www.youtube.com/VASIOT_KANAL" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center hover:bg-red-700 transition">
                                     <Youtube size={16} />
                                  </a>
                               </div>
                            </div>
