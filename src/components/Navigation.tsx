...
const Navigation: React.FC<NavigationProps> = ({ activeTab, onTabChange }) => {
  const tabs: { id: TabType; label: string; icon: React.ReactNode; color: string }[] = [
    ...
    { id: 'tactics', label: 'Тактика', icon: <PenTool size={20} />, color: 'text-orange-600 dark:text-orange-400' },
  ...
  return (
    <nav className="sticky top-0 z-40 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 shadow-sm overflow-x-auto scrollbar-hide">
